...
def _refresh_from_env() -> None:
    ...
    global (
        DIFY_API_KEY, DIFY_BASE_URL, DIFY_CV_FILE_ID, DIFY_USER,
        JOB_SEARCH_KEYWORDS, JOB_SEARCH_COUNTRY, LINKEDIN_JOB_SEARCH_URL, LINKEDIN_BASE_URL,
        RESUME_PATH, CV_PATH, EASY_APPLY_EMAIL, EASY_APPLY_FIRST_NAME, EASY_APPLY_LAST_NAME,
        EASY_APPLY_YEARS_DEFAULT, EASY_APPLY_CURRENT_COMPANY, EASY_APPLY_CURRENT_TITLE,
        EASY_APPLY_GENDER, GEMINI_API_KEY, GEMINI_MODEL, USE_GEMINI_FOR_CV,
        GROQ_API_KEY, GROQ_MODEL, DEFAULT_LOCATION_CITY, NOTICE_PERIOD_DEFAULT,
        EASY_APPLY_CERTIFICATIONS, EASY_APPLY_HYBRID_ANSWER,
        WORK_AUTHORIZATION_ANSWER, WORK_NEED_SPONSORSHIP_ANSWER, WORK_AUTHORIZATION_COUNTRY,
        USER_DATA_DIR, MIN_DELAY_SEC, MAX_DELAY_SEC, HEADLESS, LOG_FILE,
    )
